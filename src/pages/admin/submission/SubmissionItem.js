        ...
        <BoxTitle>
          ...
          <Paper elevation={0} sx={{
            ...
            <Stack direction="column" spacing={1}>
              ...
              <Typography variant="h6">
                Accuracy: {submissionItem?.accuracy.toFixed(2) + '%'}
              </Typography>
              <Typography variant="h6">
                Execution Time: {submissionItem?.executionTime > 1000 ? (submissionItem?.executionTime / 1000).toFixed(2) + 's' : submissionItem?.executionTime.toFixed(2) + 'ms'}
              </Typography>
              <Typography variant="h6">
                Execution Memories: {submissionItem?.executionMemories > 1024 ? (submissionItem?.executionMemories / 1024).toFixed(0) + 'KB' : submissionItem?.executionMemories.toFixed(0) + 'B'}
              </Typography>
            </Stack>
          </Paper>
